<template>
    ...
    <div v-else id="carousel" class="carousel mx-5">
        <div class="carousel-item w-full">
            <div
                class="card w-full h-fit p-6 bg-base-300 border-2 border-primary shadow-md rounded-lg m-6"
            >
                <div class="card-body">
...
onBeforeUnmount(async () => {
    ...
    if (isAuth.value && userId) {
        ...
        if (!profileResponse.data.has_profile) {
            ...
            addAlert(
                'warning',
                "you don't successfully create the profile. Logged out."
            );
        }
    }
});
