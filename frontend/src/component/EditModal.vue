<template>
    ...
    <div class='mt-5'>
        ...
        <div class="join">
            <input type='checkbox' class='toggle' @change='setMaxPeople' :checked='showMaxPeople'/>
            <input
                v-if='showMaxPeople'
                id='max-field'
    ...
    methods: {
        ...
        async fetchDetail() {
            ...
            try {
                ...
                this.maxPeople = this.activity.max_people || this.activity.people;
        ...
        validateInput() { 
            ...
            if (this.maxPeople < this.activity.people) {
                addAlert('warning', 'Max People must be higher or equal to current participants.')
